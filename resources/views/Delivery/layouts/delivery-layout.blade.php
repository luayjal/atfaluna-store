            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-item has-treeview "> {{-- menu-open --}}
                        <a href="{{route('Delivery.incoming')}}"
                           class="nav-link @if(request()->routeIs('Delivery.incoming.*')) active @endif">
                    ...
                    <li class="nav-item has-treeview "> {{-- menu-open --}}
                        <a href="{{route('Delivery.recived')}}"
                           class="nav-link @if(request()->routeIs('Delivery.recived.*')) active @endif">
                    ...
                    <li class="nav-item has-treeview "> {{-- menu-open --}}
                        <a href="{{route('Delivery.complete')}}"
                           class="nav-link @if(request()->routeIs('Delivery.complete.*')) active @endif">
