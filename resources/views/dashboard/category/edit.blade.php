            ...
            <form action="{{ route('admin.categories.update',$category->id)}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-12 mb-3">
                        ...
                        <input type="color" name="background_color" value="{{$category->background_color}}" class="form-control col-md-2  @error('background-color') is-invalid @enderror"
                            accept="image/*">
                    ...
                    <div class="form-group col-md-12 mb-3">
                        ...
                        <input type="color" name="font_color"  value="{{$category->font_color}}" class="form-control col-md-2  @error('font_color') is-invalid @enderror"
                            accept="image/*">
                        @error('font_color')
                            <p class="invalid-feedback">{{ $message }}</p>
                        @enderror
