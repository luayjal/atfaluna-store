...
<div class="card">
  <div  class="card-header">
    <h1 style=" color:rgb(151, 35, 35); text-align:center; font-size:50px;margin-top:20px">{{ trans('admin.add color')}} </h1>
</div>
<div>
    ...
    <div class="card-body">
        ...
        <form action="{{ route('store-color') }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="from-group col-md-6 mb-4">
            ...
            <div class="col mb-5">
                <button type="submit" class="btn btn-primary  btn-lg"> {{ trans('admin.add color') }} </button>
            </div>
