                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                        @foreach ($colors as $color)
                                            <label class="btn btn-outline-dark colorlabel"
                                                for="color{{ $color->value }}">
                                                <input type="radio" name="color" value="{{ $color->value }}"
                                                    id="color{{ $color->value }}" autocomplete="off"
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                        @foreach ($sizes as $size)
                                            <label class="btn btn-outline-dark sizelabel"
                                                for="size{{ $size->value }}">
                                                <input type="radio" name="size" value="{{ $size->value }}"
                                                    id="size{{ $size->value }}" autocomplete="off"
            ...
            <div class="bor10 m-t-50 p-t-43 p-b-40">
                ...
                <div class="tab01">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li class="nav-item p-b-10">
                            <a class="nav-link" data-toggle="tab" href="#reviews" role="tab">المرجعات
                                والتقييمات</a>
                        </li>
                    </ul>
                            ...
                            <div class="row">
                                <div class="col-sm-10 col-md-8 col-lg-6 m-lr-auto">
                                    <div class="p-b-30 m-lr-15-sm">
                                        <img class="img-fluid" src="{{ asset($product->certificate_url) }}"
                                            alt="">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane fade" id="reviews" role="tabpanel">
                            <div class="row">
                                <div class="col-sm-10 col-md-8 col-lg-6 m-lr-auto">
                                    <div class="p-b-30 m-lr-15-sm">
                                        <!-- Review -->
                                        @foreach ($product->evaluation as $evaluation)
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary js-addcart-detail">اضف للعربة</button>
                </div>
            </div>
        </div>
    </div>
